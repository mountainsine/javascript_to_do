...
function renderLocalStorage2() {
    if (retrievedDataArray && retrievedDataArray.length > 0){
      ...
      var seperatedToDoItem = JSON.stringify(retrievedDataArray[0]);
      console.log(seperatedToDoItem);
      var dataExampleVariableForTesting = JSON.parse(localStorage.getItem("testKey"));
      tag_id.innerHTML = dataExampleVariableForTesting;
    } else {
...
// Create a "close" button and append it to each list item
  ...
  function newElement() {
    console.log('We Are invoking the "newElement" function now');
    var li = document.createElement("li");
